...
/**
 * Created by viral.thakkar on 27-02-2015.
 */
public class NumberProcessor {

    private static DefaultProcessor processor = new DefaultProcessor();
    ...
    public static String getWordRepresentation(double number) {
